<%--
   Fichier chatlive/liremessages.jsp
...
<% while (true)
     ...
     {
       if (!participantsChat.contains(utilisateurForum))
         break;
       out.clearBuffer();
%><?xml version='1.0'?>
<messages>
    ...
    <%   }
       ...
       dateLectureMessagesChat.setTime(
                                 System.currentTimeMillis()); %>
</messages>
<%--   Ecriture d'un symbole de separation entre deux documents XML --%>
    <% out.write(0);
       out.flush(); %>
